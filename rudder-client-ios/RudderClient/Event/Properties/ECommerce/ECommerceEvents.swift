...
enum ECommerceEvents : Encodable {
    case PRODUCTS_SEARCHED, PRODUCT_LIST_VIEWED, PRODUCT_LIST_FILTERED, PROMOTION_VIEWED, PROMOTION_CLICKED, PRODUCT_CLICKED, PRODUCT_VIEWED, PRODUCT_ADDED, PRODUCT_REMOVED, CART_VIEWED, CHECKOUT_STEP_VIEWED, CHECKOUT_STEP_COMPLETED, PAYMENT_INFO_ENTERED, ORDER_UPDATED, ORDER_COMPLETED, ORDER_REFUNDED, ORDER_CANCELLED, COUPON_ENTERED, COUPON_APPLIED, COUPON_DENIED, COUPON_REMOVED, PRODUCT_ADDED_TO_WISH_LIST, PRODUCT_REMOVED_FROM_WISH_LIST, WISH_LIST_PRODUCT_ADDED_TO_CART, PRODUCT_SHARED, CART_SHARED, PRODUCT_REVIEWED
